...
const AddVaccinationModal: React.FC<ModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
}) => {
    ...
    >
      <div className="space-y-5">
        <div className="grid grid-cols-1 gap-4">
          ...
          <ThemeInput label="Dose one on:" onChange={() => {}} type="date" />

          <ThemeInput
            label="Taken at:"
            placeholder="Enter Taken at"
            onChange={() => {}}
            type="text"
          />
          <ThemeInput label="Next Dose:" onChange={() => {}} type="date" />
